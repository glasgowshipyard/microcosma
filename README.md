...
4. The app calculates roughtly the optimal position sizing for deep OTM SPY puts
5. Adjust purchases based on VIX to avoid overpaying during panic

**Hedgehog has one powerful defence; this is mine 🦔.**
...
- Financial data APIs (Twelve Data, Yahoo Finance) - subject to change at 🦔 whim
...
This tool is for educational purposes only. Options trading carries substantial risk of total loss. Deep OTM puts often expire worthless. This is not financial advice. You can and will lose money. You probably don't even have the ability to trade options anyway.

## // Philosophy

This is a personal strategic tool, not a real-time trading plat and the math might be kinda wrong.
